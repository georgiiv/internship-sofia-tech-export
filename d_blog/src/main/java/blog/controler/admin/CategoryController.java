...
public class CategoryController {
    ...
    public String list(Model model ,Category category){
        ...
        List<Article> categories = this.articleRepository.findAllByCategoryOrderByIdDesc(category);

        categories = categories.stream().sorted(Comparator.comparingInt(Article::getId)).collect(Collectors.toList());
