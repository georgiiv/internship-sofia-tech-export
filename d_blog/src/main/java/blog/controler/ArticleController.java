...
import blog.controler.admin.CategoryController;
...
public class ArticleController {
    ...
    public String createProcess(ArticleBindingModel articleBindingModel) throws IOException {
        ...
        byte[] articlePicture = articleBindingModel.getFile().getBytes();
        articleEntity.setArticlePicture(articlePicture);
    ...
    public String details(Model model, @PathVariable Integer id){
        ...
        model.addAttribute("articlePicture", encoded);
